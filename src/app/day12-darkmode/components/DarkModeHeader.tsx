...
type DarkModeHeaderProps = {
  title: string;
  showHomeLink?: boolean;
  className?: string;
};

export default function DarkModeHeader({ title, showHomeLink = true }: DarkModeHeaderProps) {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-white via-slate-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 backdrop-blur-xl border-b border-slate-200/50 dark:border-gray-700/50 shadow-[0_8px_32px_rgba(0,0,0,0.1)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)]">
